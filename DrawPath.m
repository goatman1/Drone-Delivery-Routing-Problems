function DrawPath(route,City,num)
%% 画路径函数
%输入
% route     待画路径   
% City      各城市坐标位置
...
% 画需求点
plot(City(2:end,1),City(2:end,2),'o','color',[0.5,0.5,0.5],'MarkerFaceColor',"#A2142F") %plot(x轴坐标,y轴坐标,圆圈,颜色,某色RGB三元组)
